...
export default function MembersPage() {
  const principalInvestigator = {
    ...
    description:
      "Junghun Cho is an Assistant Professor in the Department of Biomedical Engineering at SUNY Buffalo. He received a PhD in Biomedical Engineering in 2019 at Cornell University under supervision of Dr. Yi Wang, a MS in Physics at the University of Wisconsin Madison, and a BS in Physics at the University of Michigan Ann Arbor. From 2020 to 2022, he worked as a Postdoctoral Associate at the Weill Cornell Medicine and received a NIH K99 award on July 2021.",
    links: [
      {
      ...
      {
        label: "CV (March 2025)",
        url: "https://www.acsu.buffalo.edu/~jcho34/assets/images/Junghun_Cho_CV_0306_2025_web.pdf",
      },
    ],
  }
  ...
  const labMembers = [
    ...
    {
      name: "Praveena Elanghovan",
      title: "PhD student",
      image: "/images/members/praveena.jpg",
      description:
        "Praveena Elanghovan received a BE in Biomedical Engineering from Rajalakshmi Engineering College and a MS in Biomedical Engineering from Arizona State University. Her research project involves clinical application of OEF mapping technique.",
      links: [],
      useContain: true,
    },
    {
    ...
    },
    {
      name: "Ada Ally",
      title: "MS student",
      image: "/images/members/adaally.jpg",
      description:
        "Ada Ally received a BS in Biomedical Engineering at Manipal Institute of Technology. Her research project involves developing data processing for OEF quantification.",
      links: [],
      useContain: false,
    },
    {
      name: "Quinn Boyer",
      title: "MS student",
      image: "/images/members/quinn.jpg",
      description:
        "Quinn Boyer received a BS in Biomedical Engineering at SUNY Buffalo. His research project involves preclinical and clinical application of OEF mapping.",
      links: [],
      useContain: true,
    },
    {
      name: "Manaswini Annimalla",
      title: "MS student",
      image: "/images/members/manaswini.jpg",
      description:
        "Manaswini Annimalla received a BE in Biomedical Engineering at University College of Engineering. Her research project involves deep learning image segmentation.",
      links: [],
      useContain: true,
    },
  ]
  ...
  const alumni = [
    {
      ...
      title: "Former Postdoctoral Researcher (2021-2023)",
      currentPosition: "Assistant Professor, Johns Hopkins University",
    },
    {
      name: "Dr. Robert Thompson",
      title: "Former PhD student (2019-2024)",
      currentPosition: "Research Scientist, Google DeepMind",
    },
    {
      name: "Dr. Maria Gonzalez",
      title: "Former PhD student (2020-2024)",
      currentPosition: "Senior Data Scientist, Siemens Healthineers",
    },
    {
      name: "Alex Johnson",
      title: "Former MS student (2022-2024)",
      currentPosition: "PhD student, Harvard University",
    },
    {
      name: "Dr. Kevin Park",
      title: "Former Postdoctoral Researcher (2020-2022)",
      currentPosition: "Principal Investigator, Seoul National University",
    },
    {
      name: "Lisa Zhang",
      title: "Former MS student (2021-2023)",
      currentPosition: "MRI Physicist, Mayo Clinic",
    },
  ]
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <p className="text-foreground text-sm font-sans">
                    <span className="font-medium">Current Position:</span> {alumnus.currentPosition}
                  </p>
                </div>
              </div>
            </Card>
