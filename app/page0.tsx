...
export default function HomePage() {
  const recentNews = [
    ...
    },
    {
      ...
      description:
        "Our lab received a NIH K99 award: Development and Validation of MRI mapping of brain oxygen metabolism for clinical use.",
    },
    {
      date: "2022-09-01",
      ...
      description:
        "Our lab started operations, beginning our research into functional neuroimaging and brain oxygen metabolism.",
    },
  ]
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-16">
        <div className="flex flex-col items-center text-center space-y-8">
          <div className="max-w-4xl mb-0 mt-12">
            <h1 className="font-bold text-primary mb-8 text-5xl font-sans">Functional Neuroimaging Lab</h1>
            <p className="text-lg text-foreground mb-8 leading-relaxed font-sans">
              Our research lab is dedicated to understanding the human brain through advanced neuroimaging techniques.
              We use functional MRI, diffusion tensor imaging, and other cutting-edge methods to investigate brain
              function, connectivity, and structure in health and disease.
            </p>
      ...
      <section className="mb-16">
        <div className="text-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            />
            <p className="text-sm text-foreground/70 mt-6 leading-relaxed font-sans">
      ...
      <section className="mb-16">
        <Card className="bg-muted border-secondary/20">
          <CardHeader>
            <CardTitle className="text-primary font-sans">Our Mission</CardTitle>
          </CardHeader>
          <CardContent>
